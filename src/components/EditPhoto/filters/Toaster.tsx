  ...
  render() {
    ...
    return <Node
      ...
      uniforms={{
        ...
        inputImageTexture5: resolveAssetSource(require('@assets/resources/toasterOverlayMapWarm.png')),
        inputImageTexture6: resolveAssetSource(require('@assets/resources/toasterColorShift.png'))
      }} />;
  }
}
